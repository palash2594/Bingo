 ...
 */
public class Bingo_test extends ActionBarActivity {
    ...
    public int checker(){
        ...
        if(flag[5][1]==2 && flag[6][1]==2 && flag[7][1]==2 && flag[8][1]==2 && flag[9][1]==2 && loop[1]==0){
            loop[1] = 1;
            check++;
        }
        if(flag[10][1]==2 && flag[11][1]==2 && flag[12][1]==2 && flag[13][1]==2 && flag[14][1]==2 && loop[2]==0){
            loop[2] = 1;
            check++;
        }
        if(flag[15][1]==2 && flag[16][1]==2 && flag[17][1]==2 && flag[18][1]==2 && flag[19][1]==2 && loop[3]==0){
            loop[3] = 1;
            check++;
        }
        if(flag[20][1]==2 && flag[21][1]==2 && flag[22][1]==2 && flag[23][1]==2 && flag[24][1]==2 && loop[4]==0){
            loop[4] = 1;
            check++;
        }
        if(flag[0][1]==2 && flag[5][1]==2 && flag[10][1]==2 && flag[15][1]==2 && flag[20][1]==2 && loop[5]==0){
            loop[5] = 1;
            check++;
        }
        if(flag[1][1]==2 && flag[6][1]==2 && flag[11][1]==2 && flag[16][1]==2 && flag[21][1]==2 && loop[6]==0){
            loop[6] = 1;
            check++;
        }
        if(flag[2][1]==2 && flag[7][1]==2 && flag[12][1]==2 && flag[17][1]==2 && flag[22][1]==2 && loop[7]==0){
            loop[7] = 1;
            check++;
        }
        if(flag[3][1]==2 && flag[8][1]==2 && flag[13][1]==2 && flag[18][1]==2 && flag[23][1]==2 && loop[8]==0){
            loop[8] = 1;
            check++;
        }
        if(flag[4][1]==2 && flag[9][1]==2 && flag[14][1]==2 && flag[19][1]==2 && flag[24][1]==2 && loop[9]==0){
            loop[9] = 1;
            check++;
        }
        if(flag[0][1]==2 && flag[6][1]==2 && flag[12][1]==2 && flag[18][1]==2 && flag[24][1]==2 && loop[10]==0){
            loop[10] = 1;
            check++;
        }
        if(flag[4][1]==2 && flag[8][1]==2 && flag[12][1]==2 && flag[16][1]==2 && flag[20][1]==2 && loop[11]==0){
            loop[0] = 1;
            check++;
        }
